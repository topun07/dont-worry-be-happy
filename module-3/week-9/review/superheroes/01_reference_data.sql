...
CREATE TABLE superhero (
  ...
  CONSTRAINT fk_sup_eyecol FOREIGN KEY (eye_color_id) REFERENCES color (id),
  CONSTRAINT fk_sup_gen FOREIGN KEY (gender_id) REFERENCES gender (id),
  CONSTRAINT fk_sup_haircol FOREIGN KEY (hair_color_id) REFERENCES color (id),
  ...
  CONSTRAINT fk_sup_skincol FOREIGN KEY (skin_color_id) REFERENCES color (id)
);
