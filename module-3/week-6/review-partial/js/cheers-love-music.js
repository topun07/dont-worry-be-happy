...
document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    wordDiv.setAttribute('id', 'music-word-div');
   ...
   cheersWord.addEventListener('mouseover', (event) => {
    ...
    /* Step 11: Add a listener to the cheers-word span that calls the toggleColor
        ...
        out of the element
    */
        cheersWord.addEventListener('mouseleave', (event) => {
            toggleColor(event.currentTarget);
           });
    ...
    */
   const cheersImage = document.getElementById('cheers-image');
   cheersImage.addEventListener('click', (event) => {
    toggleColor(event.currentTarget);
   })
