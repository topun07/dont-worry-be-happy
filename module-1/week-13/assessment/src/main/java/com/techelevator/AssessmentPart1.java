...
public class AssessmentPart1 {
	...
	*/
	public int Q04_moviePriceMatinee(int age, boolean isBefore5pm, boolean isWeekend) {
		...
		if (age <= 12 && isBefore5pm == true && isWeekend == true) {
			return 7;
		}
		if (age <= 12 && isBefore5pm == true && isWeekend == false) {
			return 5;
		}
		if (age <= 12 && isBefore5pm == false && isWeekend == true) {
			return 7;
		}
		if (age <= 12 && isBefore5pm == false && isWeekend == false) {
			return 7;
		}
		if (age > 12 && isBefore5pm == true && isWeekend == true) {
			return 12;
	...
	*/
	public int Q05_sumOfOddNumbersBetween(int lowestNumber, int highestNumber) {
		if (highestNumber < lowestNumber) {
			return 0; // Return 0 if highestNumber is less than lowestNumber
		}

		int sum = 0;
		for (int num = lowestNumber; num <= highestNumber; num++) {
	...
	*/
	public String Q07_spaceReplacer(String stringValue, String replaceSpaceWith) {
		stringValue = stringValue.replaceAll(" ", replaceSpaceWith);
		return stringValue;
	}
	...
	*/
	public double Q08_convertToFahrenheit(double degreesCelsius) {
		double degreesFahrenheit = ((double) 9 / 5) * degreesCelsius + 32.0;
	...
	*/
	public int[] Q10_swapFirstAndLastElements(int[] arrayOfInts) {
		...
		if (arrayOfInts == null || arrayOfInts.length <= 1){
			return arrayOfInts;
		}
		...
		arrayOfInts[0] = last;
		arrayOfInts[arrayOfInts.length-1] = first;
